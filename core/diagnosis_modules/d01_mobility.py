...
class MobilityDetector:
    ...
    def detect_ping_pong_sessions(
        ...
        for nxt in raw_ping_pongs[1:]:
            ...
            # Guard 1: Time gap tolerance <= 5.0s
            # Guard 2: Overlapping cell topology (shares at least 1 cell)
            # Guard 3: Max distinct cell limit <= 4 to prevent unbounded bloating
            can_merge = (gap_sec <= 5.0) and bool(curr_cells & nxt_cells) and (len(combined_cells) <= 4)
